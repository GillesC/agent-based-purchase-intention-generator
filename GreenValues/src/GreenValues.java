 ...
 */
public class GreenValues {
    /* Shop parameters */
    public static double GREEN_PERCEIVED_RISK_CONTRIBUTION_PERCENTIGE = 14.8;
    public static double GREEN_PERCEIVED_TRUST_CONTRIBUTION_PERCENTIGE = 18;
